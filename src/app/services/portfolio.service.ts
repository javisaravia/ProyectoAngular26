    ...
    private projects: Project[] = [
        {
            ...
            image: 'C:\Users\Usuario1\Downloads\proyectoo-main\proyectoo-main\src\fondo.jpg',
        ...
        },
        {
            ...
            image: 'C:\Users\Usuario1\Downloads\proyectoo-main\proyectoo-main\src\fondo.jpg',
            technologies: ['JAVA', 'SQL', 'Node.js', 'Socket.io', 'MongoDB'],
            date: new Date('2025-05-20'),
            featured: true
        },
        {
            id: 3,
            title: 'PWA de Pronóstico del Tiempo',
            description: 'Aplicación web progresiva que proporciona pronósticos meteorológicos precisos. Utiliza la API OpenWeatherMap, geolocalización y estrategias de caché offline.',
            image: 'https://placehold.co/600x400/2980b9/ffffff?text=Clima+PWA',
            technologies: ['Angular', 'PWA', 'Service Workers', 'OpenWeatherMap API'],
